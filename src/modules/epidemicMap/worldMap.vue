<template>
  <div>
    ...
    <!-- 初始化echarts需要有个宽高的盒子 -->
    <div ref='mapbox' class='world'></div>
  </div>
</template>
<script>
    ...
    getData(){
      jsonp('https://interface.sina.cn/news/wap/fymap2020_data.d.json?_=1580892522427',{},(err,data)=>{
          if(!err){
            //代表请求数据成功
            // eslint-disable-next-line no-unused-vars
            this.number.ecertain = data.data.othertotal.ecertain;
            this.number.ecertain_inc = data.data.othertotal.ecertain_inc;
            this.number.certain = data.data.othertotal.certain;
            this.number.certain_inc = data.data.othertotal.certain_inc;
            this.number.recure = data.data.othertotal.recure;
            this.number.recure_inc = data.data.othertotal.recure_inc;
            this.number.die = data.data.othertotal.die;
            this.number.die_inc = data.data.othertotal.die_inc;
          }
        })
